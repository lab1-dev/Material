...
class MudScrollSpy {
    ...
    spying(dotnetReference:any, selector:any) {
        this.scrollToSectionRequested = null;
        this.lastKnowElement = null;
    ...
    handleScroll(dotnetReference:any, selector:any, event:any) {
        ...
        if (this.scrollToSectionRequested != null) {
            if (this.scrollToSectionRequested == ' ' && window.scrollY == 0) this.scrollToSectionRequested = null;
            else {
                if (elementId === this.scrollToSectionRequested) this.scrollToSectionRequested = null;
            }
            return;
        }
